  ...
  return (
    ...
    >
      <div className="w-full max-w-3xl p-6 bg-white rounded-lg shadow-lg">
        <h1 className="pt-8 text-4xl font-bold text-center text-customTeal mb-8">
          Register
        </h1>
        ...
        >
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            <p className="text-base md:text-lg font-semibold text-customTeal mb-4 md:mb-0">
              Account Type
            </p>
          ...
          <div className="w-full flex justify-center mt-6">
            <button
              type="submit"
              className="custom-teal-button hover:bg-red-700 px-6 py-3 w-full rounded-lg shadow-md hover:shadow-lg transition-all"
            >
              Sign Up
            </button>
          </div>
